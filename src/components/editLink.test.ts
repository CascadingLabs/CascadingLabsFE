...
// project root (e.g. `.generated/docs/yosoi-docs/yosoi/index.mdx`). The transform
// only cares about the `/.generated/docs/<source>/` segment, so it should work
...
describe('transformEditUrl', () => {
	describe('yosoi pages', () => {
		it('rewrites a page in the yosoi/ subdirectory', () => {
			const input = `${SYNTH_BASE}.generated/docs/yosoi-docs/yosoi/index.mdx`;
		...
		it('rewrites a page in guides/', () => {
			const input = `${SYNTH_BASE}.generated/docs/yosoi-docs/guides/selectors.md`;
			expect(transformEditUrl(input)).toBe(
		...
		it('rewrites a deeply nested page', () => {
			const input = `${SYNTH_BASE}.generated/docs/yosoi-docs/guides/examples/news-portal.md`;
			expect(transformEditUrl(input)).toBe(
		...
		it('rewrites a top-level .mdx file', () => {
			const input = `${SYNTH_BASE}.generated/docs/yosoi-docs/roadmap.mdx`;
			expect(transformEditUrl(input)).toBe(
	...
	describe('voidcrawl pages', () => {
		it('rewrites a page in voidcrawl/', () => {
			const input = `${SYNTH_BASE}.generated/docs/voidcrawl-docs/voidcrawl/installation.mdx`;
			expect(transformEditUrl(input)).toBe(
		...
		it('rewrites a page in voidcrawl/guides/', () => {
			const input = `${SYNTH_BASE}.generated/docs/voidcrawl-docs/voidcrawl/guides/async-native.mdx`;
			expect(transformEditUrl(input)).toBe(
		...
		it('rewrites a page in reference/ (top-level of submodule)', () => {
			const input = `${SYNTH_BASE}.generated/docs/voidcrawl-docs/reference/api-reference.md`;
			expect(transformEditUrl(input)).toBe(
	...
	describe('opensesame pages', () => {
		it('rewrites a page in opensesame/', () => {
			const input = `${SYNTH_BASE}.generated/docs/opensesame-docs/opensesame/installation.mdx`;
			expect(transformEditUrl(input)).toBe(
		...
		it('rewrites a page in opensesame/reference/', () => {
			const input = `${SYNTH_BASE}.generated/docs/opensesame-docs/opensesame/reference/api-reference.md`;
			expect(transformEditUrl(input)).toBe(
	...
	describe('input shapes', () => {
		it('accepts a URL object (Starlight gives us URL, not string)', () => {
			const input = new URL(
				`${SYNTH_BASE}.generated/docs/yosoi-docs/yosoi/index.mdx`,
			);
			expect(transformEditUrl(input)).toBe(
				'https://github.com/CascadingLabs/YosoiDocs/blob/main/yosoi/index.mdx',
			);
	...
	describe('robustness to baseUrl changes', () => {
		it('leaves old submodule paths unchanged', () => {
			const input =
