...
// project root (e.g. `.generated/docs/yosoi-docs/yosoi/index.mdx`). The
// transform only cares about the `/.generated/docs/<source>/` segment, so it
// should work regardless of which baseUrl is configured.
...
describe('transformEditUrl', () => {
	...
	describe('voidcrawl pages', () => {
		...
		it('rewrites a page in reference/ at the source root', () => {
	...
	describe('robustness to baseUrl changes', () => {
		it('leaves non-generated docs paths unchanged', () => {
			const input =
				'https://github.com/CascadingLabs/YosoiDocs/edit/main/yosoi/index.mdx';
			expect(transformEditUrl(input)).toBe(input);
		});
	});
});
